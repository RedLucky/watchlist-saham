          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 font-bold uppercase tracking-wider text-[10px] sticky top-0 z-20 shadow-xs border-b border-slate-200 dark:border-slate-800">
              <tr>
                ...
                <th className="p-3 bg-slate-100 dark:bg-slate-900 text-center">Match Score</th>
                      ...
                      <td className="p-3 text-center">
                        <div className="inline-flex flex-col items-center">
                          ...
                          {selectedInvestorId === 'all' && stock.bestLegend && (
                            <span className="text-[9px] text-slate-400 mt-0.5 line-clamp-1">{stock.bestLegend.split(' ')[0]}</span>
                          )}
                        </div>
                      </td>
