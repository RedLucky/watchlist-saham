            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="space-y-1">
                <div className="flex items-center gap-3 flex-wrap">
                  <span className="text-2xl md:text-3xl font-black tracking-tight">{stockDetail.ticker}</span>
                ...
                <h2 className="text-sm md:text-base text-slate-300 font-medium">{stockDetail.name}</h2>
              ...
              <div className="flex items-center gap-4 justify-between md:justify-end">
                ...
                <div className="flex flex-col gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold rounded-xl shadow-lg transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
                  >
                    <span>💾</span> Simpan ke Koleksi
                  </button>
                  <button
                    onClick={() => handleSelectStock(stockDetail.ticker)}
                    className="px-3 py-1.5 bg-white/10 hover:bg-white/20 text-slate-200 text-xs font-medium rounded-xl transition-all text-center"
