      ...
      <div className="w-full px-4 sm:px-6 py-2.5">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            {user && (
              <div className="flex items-center gap-2 sm:gap-3 bg-slate-100 dark:bg-white/5 px-2.5 sm:px-3 py-1.5 rounded-xl border border-slate-200 dark:border-white/10 flex-shrink-0">
                ...
                <span className="text-xs font-bold text-slate-800 dark:text-white truncate max-w-[80px] sm:max-w-none">
                  {user?.name}
                </span>
                <button
                  onClick={handleLogout}
                  className="text-xs text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 font-bold px-2 py-1 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 transition-colors flex-shrink-0"
