...
export const MODES = {
  ...
  growth: {
    ...
    label: 'Pertumbuhan',
    emoji: '🚀',
    description: 'Fokus pada saham momentum dan tren dengan fundamental sehat.',
    weights: {
      fundamental: 30,
      technical: 30,
      trending: 15,
...
export const TRADING_STYLES = {
  scalping: {
    ...
    weights: { technical: 35, fundamental: 25, trending: 15, smartMoney: 10, valuation: 7, liquidity: 5, dividend: 3 },
  ...
  daily: {
    ...
    weights: { fundamental: 30, technical: 30, trending: 15, smartMoney: 10, valuation: 7, liquidity: 5, dividend: 3 },
    exit: { tp: 4.5, sl: 2.5 },
    maxHoldingDays: 5,
  ...
  swing: {
    ...
    weights: { fundamental: 35, technical: 25, trending: 15, smartMoney: 10, valuation: 5, dividend: 5, liquidity: 5 },
    exit: { tp: 8.5, sl: 4.0 },
    maxHoldingDays: 14,
