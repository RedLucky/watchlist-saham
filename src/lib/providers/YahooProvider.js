...
const TARGET_TICKERS = [
  ...
  'UNVR.JK', 'ICBP.JK', 'INDF.JK', 'MYOR.JK', 'AMRT.JK', 'MIDI.JK', 'LPPF.JK', 'MAPA.JK', 'MAPI.JK', 'KLBF.JK', 'SIDO.JK',
  'ADRO.JK', 'PTBA.JK', 'ITMG.JK', 'UNTR.JK', 'HRUM.JK', 'INCO.JK', 'ANTM.JK', 'MDKA.JK', 'PGEO.JK', 'PTRO.JK', 'MBMA.JK', 'AMMN.JK', 'BUMI.JK', 'ENRG.JK', 'MEDC.JK', 'AKRA.JK', 'CUAN.JK',
  'JSMR.JK', 'WIKA.JK', 'PTPP.JK', 'ADHI.JK', 'WSKT.JK', 'CMNP.JK',
  'BSDE.JK', 'CTRA.JK', 'SMRA.JK', 'PWON.JK', 'ASRI.JK', 'PANI.JK',
  'GOTO.JK', 'BUKA.JK', 'WIFI.JK', 'EMTK.JK', 'SCMA.JK',
